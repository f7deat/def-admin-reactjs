...
export default class Login extends React.Component {
    render() {
        return (
            <div className="d-flex align-items-center justify-content-around h-100 container">
                <div className="login-logo ml-4">
                    <svg id="a5c16198-98a1-478b-8909-43624583dcf2" xmlns="http://www.w3.org/2000/svg" height="300" viewBox="0 0 793 551.73152">
                        ...
                        <g id="icon">
                            <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#1e81d6" />
                        ...
                        <path d="M409.41752,423.55243c-27.13873,18.49308-46.31418.63272-60.94729-26.92346,2.03338-16.86188-1.259-37.04061-7.35672-58.96635a40.13762,40.13762,0,0,1,24.50567-48.40124h0l32.06116,13.421c27.22362,22.19038,32.582,46.227,22.36825,71.5784Z" transform="translate(-203.5 -174.13424)" fill="#1e81d6" />
                        ...
                        <path d="M361.14557,329.52422c-12.43861-5.4511-23.74934.47044-38.026,5.21926l-2.23683-39.51725c14.17612-7.55568,27.69209-9.59281,40.26285-3.728Z" transform="translate(-203.5 -174.13424)" fill="#1e81d6" /><circle cx="172.52496" cy="78.09251" r="23.80211" fill="#ffb8b8" />
                ...
                <form className="form-signin p-4">
                    <h1 className="h3 mb-4 font-weight-bold">Please sign in</h1>
                    ...
                    <Link to="/dashboard" className="btn btn-primary btn-block font-weight-bold">Sign in</Link>
                </form>
